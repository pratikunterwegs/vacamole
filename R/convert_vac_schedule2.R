...
convert_vac_schedule2 <- function(vac_schedule,
  ...
  if (num_age_groups == 10) {
    vac_schedule <- vac_schedule %>%
      ...
      select(
        ...
        -.data$pf_d1_10, -.data$pf_d2_10, -.data$pf_d3_10, -.data$pf_d4_10,
        -.data$pf_d5_10,
        -.data$mo_d1_10, -.data$mo_d2_10, -.data$mo_d3_10, -.data$mo_d4_10,
        -.data$mo_d5_10,
  ...
  if (wane) {
    ...
    # fill(comp_ve_sev, .direction = c("down")) %>%
    ...
    rtn <- ve_comp_eta %>%
      ...
      mutate(
        param = ifelse((param == "comp_ve_inf" | param == "comp_ve_sev"), "comp_ve", param),
