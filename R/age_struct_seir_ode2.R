#' @title Age-structured SEIR ODE model of vaccination with 2 dose primary
#' series with 3 booster doses (3rd, 4th, and 5th doses)
...
age_struct_seir_ode2 <- function(times, init, params) {
  with(as.list(c(params, init)), {
    ...
    # output --------------------------------------------------------
    list(c(
      dt, dS, dSv_1d, dSv_2d, dSv_3d, dSv_4d, dSv_5d,
